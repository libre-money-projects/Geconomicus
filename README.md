# jeudelamonnaie
jeudelamonnaie (gameofmoney in english, juegodelamoneda en espanol) is a set of free graphics and tools to play a generic economy simulation based on 80 years human life expectancy or more, with different money systems, inclunding specifically a freedom money system as demonstrated in Relative Money Theory = a money system based on an Universal Dividend.
...
- Project to code an online jeudelamonnaie game.

...
\( "${MARKERS_PATH}/marker_1.png" -resize 205x280 -rotate 270 \) -geometry +35+80 -composite \
\( "${MARKERS_PATH}/marker_2.png" -resize 205x280 -rotate 270 \) -geometry +320+80 -composite \
\( "${MARKERS_PATH}/marker_3.png" -resize 205x280 -rotate 270 \) -geometry +600+80 -composite \
\( "${MARKERS_PATH}/marker_4.png" -resize 205x280 -rotate 270 \) -geometry +320+330 -composite \
